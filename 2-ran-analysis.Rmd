...
# plotting the three types of heights against age

# indoor variables

indoor_plant_height <- filter(height_table, variable_name == 'plant_height')

ggplot(indoor_plant_height, aes(x = age, y = height_cm)) +
