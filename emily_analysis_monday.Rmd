...
indoor_table_plant_height <- indoor_table[indoor_table$variable_name == 'plant_height',]
outdoor_table_canopy_height_summer <- outdoor_table[outdoor_table$variable_name == 'canopy_height' & outdoor_table$date %within% interval(as.POSIXct("2016-01-01 01:00:00"), as.POSIXct("2016-08-01 01:00:00")), ]
outdoor_table_canopy_height_fall <- outdoor_table[outdoor_table$variable_name == 'canopy_height' & outdoor_table$date %within% interval(as.POSIXct("2016-08-01 01:00:00"), as.POSIXct("2016-12-01 01:00:00")), ]
...
indoor_growthmodel <- lm(mean ~ date, data = indoor_table_plant_height)
summary(indoor_growthmodel)

outdoorsummer_growthmodel <- lm(mean ~ date, data = outdoor_table_canopy_height_summer)
summary(outdoorsummer_growthmodel)

outdoorfall_growthmodel <- lm(mean ~ date, data = outdoor_table_canopy_height_fall)
summary(outdoorfall_growthmodel)

plot(x=indoor_table_plant_height$date, y=indoor_table_plant_height$mean, type = 'p')  
